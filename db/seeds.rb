...
Order.create!([total_price: 2999, plan_id: 27, creator_name: "许昕", backer_name: "李项", price: 2999, quantity: 1, payment_method: "Alipay", aasm_state: "paid", user_id: 5, project_id: 1, plan_description: "赠送《一支笔的静心之旅：钢笔淡彩风景速写》图书及一套明信片。", project_name: "用钢笔送你一个淡彩梦！", address: Address.find(1).address_tos])
BillPayment.create(
...
Order.create!([total_price: 500, plan_id: 7, creator_name: "吴涛", backer_name: "纪梵希", price: 500, quantity: 1, payment_method: "Alipay", aasm_state: "paid", user_id: 2, project_id: 2, plan_description: "价值 125 元的《梵高地图：追寻梵高一生的轨迹》图书一本、价值 99 元梵高纪念版花球一盒（6个）、价值 128 元梵高纪念版糖果一盒（10支）", project_name: "梵高地图 虚拟现实艺术大展", address: Address.find(3).address_tos])
BillPayment.create(
